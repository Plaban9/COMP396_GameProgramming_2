...
public class Flock : MonoBehaviour
{
    ...
    [SerializeField] private Flock[] otherFlocks;       //Unity Flocks in the group
    ...
    private void Awake()
    {
        ...
        //Null Parent as the flock leader will be FlockController object
        ...
        for (int i = 0; i < objects.Length; i++)
        {
            ...
            if (boidTransform != transformComponent)
            {
                ...
                if (directionMagnitude < followRadius)
                {
                    ...
                    Flock tempOtherBoid = otherFlocks[i];
